# Issue #17 provisional evidence (superseded)

This directory preserves the first durability-matched live A/B run produced by Dgraph commit
`0d7d559c9ec4cae14c16b9990c41f206e2602862`. It is historical and provisional, not current decision
evidence: timed reads did not validate response contents, the logical checksum omitted edge
topology, and the initial metric/context contract was incomplete. The corrected evidence is in
[`../issue-17`](../issue-17/README.md).
